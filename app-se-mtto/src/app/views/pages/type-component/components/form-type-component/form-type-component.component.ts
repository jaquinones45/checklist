...
@Component({
  selector: 'app-form-type-component',
  templateUrl: './form-type-component.component.html',
  styleUrls: ['./form-type-component.component.scss']
})
export class TypeComponentTypeComponentComponent {
  closeResult = ''
  load: boolean = false
  modal: boolean = false
  plants: any = []
  ...
  constructor(
    ...
    private typeSystemService: TypeComponentService,
  ...
  submitTypeComponent(form: NgForm) {
    if(!form.valid) {
      return false;
    } else {
